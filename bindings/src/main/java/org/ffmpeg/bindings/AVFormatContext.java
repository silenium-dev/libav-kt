...
public class AVFormatContext {
     ...
     * }
     */
    public final static class control_message_cb {

        private control_message_cb() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = FFMPEG.upcallHandle(control_message_cb.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(control_message_cb.Function fi, Arena arena) {
