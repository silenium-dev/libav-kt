...
public class av_alias64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        FFMPEG.C_LONG.withName("u64"),
        MemoryLayout.sequenceLayout(2, FFMPEG.C_INT).withName("u32"),
        MemoryLayout.sequenceLayout(4, FFMPEG.C_SHORT).withName("u16"),
        MemoryLayout.sequenceLayout(8, FFMPEG.C_CHAR).withName("u8"),
        FFMPEG.C_DOUBLE.withName("f64"),
        MemoryLayout.sequenceLayout(2, FFMPEG.C_FLOAT).withName("f32")
    ).withName("av_alias64");
    ...
    private static final long u64$OFFSET = $LAYOUT.byteOffset(groupElement("u64"));
    ...
    private static final SequenceLayout u32$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("u32"));
     ...
     * }
     */
    public static final SequenceLayout u32$layout() {
        return u32$LAYOUT;
    }
     ...
     * }
     */
    public static MemorySegment u32(MemorySegment union) {
        return union.asSlice(u32$OFFSET, u32$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void u32(MemorySegment union, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, union, u32$OFFSET, u32$LAYOUT.byteSize());
    }

    private static long[] u32$DIMS = { 2 };
     ...
     * }
     */
    public static long[] u32$dimensions() {
        return u32$DIMS;
    }
    private static final VarHandle u32$ELEM_HANDLE = u32$LAYOUT.varHandle(sequenceElement());
     ...
     * }
     */
    public static int u32(MemorySegment union, long index0) {
        return (int)u32$ELEM_HANDLE.get(union, 0L, index0);
    }
     ...
     * }
     */
    public static void u32(MemorySegment union, long index0, int fieldValue) {
        u32$ELEM_HANDLE.set(union, 0L, index0, fieldValue);
    }
    ...
    private static long[] u16$DIMS = { 4 };
    ...
    private static final long f64$OFFSET = $LAYOUT.byteOffset(groupElement("f64"));
    ...
    private static final SequenceLayout f32$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("f32"));
     ...
     * }
     */
    public static final SequenceLayout f32$layout() {
        return f32$LAYOUT;
    }
     ...
     * }
     */
    public static MemorySegment f32(MemorySegment union) {
        return union.asSlice(f32$OFFSET, f32$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void f32(MemorySegment union, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, union, f32$OFFSET, f32$LAYOUT.byteSize());
    }

    private static long[] f32$DIMS = { 2 };
     ...
     * }
     */
    public static long[] f32$dimensions() {
        return f32$DIMS;
    }
    private static final VarHandle f32$ELEM_HANDLE = f32$LAYOUT.varHandle(sequenceElement());
     ...
     * }
     */
    public static float f32(MemorySegment union, long index0) {
        return (float)f32$ELEM_HANDLE.get(union, 0L, index0);
    }
     ...
     * }
     */
    public static void f32(MemorySegment union, long index0, float fieldValue) {
        f32$ELEM_HANDLE.set(union, 0L, index0, fieldValue);
    }
